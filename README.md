...
Browser issues
==============
It does not work on Opera and it looks a bit weird in Chrome ([labels are far away from the circles representing metro stations](https://en.wikipedia.org/wiki/Milan_Metro_Line_5)). It looks fine on Firefox.
